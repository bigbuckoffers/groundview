export const packages = {
  ...
  standard:           { name: 'Interior/Exterior Photos – Standard',           price: 9500,  label: '$95' },
  // Order types
  ...
  // Legacy rush/premium kept for API compatibility
  rush:               { name: 'Rush 24-Hour Package',                          price: 12000, label: '$120' },
  premium:            { name: 'Premium Photo + Report',                        price: 14000, label: '$140' },
};

export type PackageKey = keyof typeof packages;

export const BASE_PRICE = 9500;
